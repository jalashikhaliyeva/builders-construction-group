          ...
          <div className="flex gap-0 pr-4">
            ...
            >
              ...
              >
                <Menu.Items
                  static
                  className="z-25000 w-64 origin-top-left rounded-xl border border-white/5 bg-white p-3 text-sm/6 text-black [--anchor-gap:var(--spacing-1)] focus:outline-none shadow-md  mt-3"
                  anchor="bottom-left"
                >
        ...
        <ul className="flex space-x-4 ">
          ...
          <div className="flex ">
            <Menu
              ...
              as="div"
              className={`${style.menuNavHeader} relative inline-block text-left flex gap-0 pr-4`}
            >
              <Menu.Button
                style={{
                  boxShadow: "none",
              ...
              >
                <Menu.Items
                  static
                  className="z-25000  origin-top-left rounded-xl border border-white/5 bg-white p-3 text-sm/6 text-black [--anchor-gap:var(--spacing-1)] focus:outline-none shadow-md  mt-3"
                  anchor="bottom-left"
                >
          ...
          <li
            ...
            onClick={() => push(ROUTER.CONTACT)}
            className={`${style.headLi} ${
              isActive(ROUTER.CONTACT) ? style.active : ""
            }`}
          >
            {t("əlaqə")}
          </li>
